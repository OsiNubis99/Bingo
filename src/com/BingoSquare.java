...
public class BingoSquare extends Rectangle {
    ...
    /**
     * Constructor for BingoSquare Contraints of the number of the square is
     * determined by its column location
     * 
     ...
     * 
     * @return true if the square has been clicked false if the square has not been
     *         clicked
     */
